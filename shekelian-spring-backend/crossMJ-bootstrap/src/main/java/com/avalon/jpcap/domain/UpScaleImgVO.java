...
/**
 * @author DingHaoLun
 * @since 2023-04-24 21:11
 **/
@Data
@EqualsAndHashCode(callSuper = true)
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(description = "MJ upScale图片提示词")
public class UpScaleImgVO extends BaseControllerDomain {

    @ApiModelProperty(value = "生成记录的主键id", required = true)
    private Long imgRecordId;

    @ApiModelProperty(value = "要放大的图片的id号", required = true)
